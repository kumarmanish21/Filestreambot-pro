...
async def start(b, m):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            await b.send_message(
                chat_id=m.chat.id,
                text="<i>⸙ꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋ🕊️⃝🎀🇬𝐢𝐫𝐥🇫𝐫𝐢𝐞𝐧𝐝4ᑌ 𝄗⃝❤️❥✿્᭄͜͡𝆺𝅥𝄞 ❷❹×➐ |🇮🇳‌ ¤๋ࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣩࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧ͜͡</i> <b> <a href='https://t.me/joinchat/MnPFCkvcDjZCbjE09lngIw'>CLICK HERE FOR SUPPORT </a></b>",
    ...
    await StreamBot.send_photo(
        ...
        caption =f'Hi {m.from_user.mention(style="md")}!,\nI am Telegram File to Link Generator Bot with Channel support. Join➡️@Girlfriend4u_Official \nSend me any file and get a direct download link and streamable link.!',
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="__Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ__ [Support](https://t.me/joinchat/MnPFCkvcDjZCbjE09lngIw).",
                disable_web_page_preview=True)
            return
...
<b> I also support Channels, add me to you Channel and send any media files and see miracle✨ also send /list to know all commands""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("💁‍♂️ Owner", url="@kumar_manis")],
                [InlineKeyboardButton("💥 Source Code", url="https://t.me/joinchat/MnPFCkvcDjZCbjE09lngIw")]
            ]
        )
    )
